...
const to_arraybuffer = require('../huay/to-arraybuffer')
...
class client extends events {
      ...
      switch (command.iCmdType) {
        case HUYA.EWebSocketCommandType.EWSCmd_WupRsp:
          try {
            ...
            console.log('what name', wup.sFuncName)
          } catch (e) {
  ...
  sendMsg(content) {
    ...
    if (
      ...
      ;(a.iAppId = 1), (a.sTag = ''), n.vTagInfo.value.push(a)
    }
    let wup = new Taf.Wup()
  ...
  getSequence() {
    ...
    ;(i.tId = this.getUserId()), (i.iSeqNum = 1), (i.iFromType = 5), (i.iBusinessType = 1)
    let r = [
      this._get_cookie_value('yyuid'),
      i.iSeqNum,
      i.iFromType,
      i.iBusinessType,
      'AzCXiouW6aLc4AsVGKAOOLlNLawNQsuV',
    ].join('')
    ;(r = md5(r)), (i.sSgin = r), console.log(i)
  ...
  consumeGift(sPayId, iItemType, iItemCount) {
    ...
    var w = (function () {
      ...
      var e = t.split(''),
        i = e[2]
      return (e[2] = e[3]), (e[3] = i), e.reverse(), (t = e.join('')), parseInt(t + '0', 2) + 1
    })()
    ;(w += 64),
      (f.iPayPloy = w),
      (f.iFromType = 5),
